<nav x-data="{ open: false }" class="bg-blue-800 text-white border-b border-gray-700">
            ...
            <div class="flex">
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ asset('images/clinic-logo.png') }}" alt="Clinic Logo" class="block h-10 w-auto">
                    </a>
                </div>
                <!-- Dashboard Link -->
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-600">
            ...
            <div class="mt-3 space-y-1">
                ...
                <x-responsive-nav-link :href="route('inventory.index')">
                    {{ __('Inventory') }}
                </x-responsive-nav-link>
